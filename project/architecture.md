...
**Status**: rel-01 released (2025-11-16) - Full REPL with scrollback, viewport scrolling, and comprehensive test coverage.
...
- 80% coverage per file requirement (lines, functions, branches)
