...
See User Extension Example section for complete implementation. No protocol libraries, registration, or manifest files needed.
...
`/tool` lists discovered tools. `/tool <name>` shows schema and path for specific tool.
