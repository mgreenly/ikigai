...
Phase 17 ✅ realizes D17 — per-hook verification schemes `bearer`/`github-hmac`: new migration (verification + retained secret columns), scheme-aware create/list/rotate, HMAC-SHA256 ingress path (body-first under cap, uniform 404, `headers` allowlist in payload); covers R-G7RX-751P, R-G8ZT-KWSE, R-GA7P-YOJ3, R-GBFM-CG9S, R-GCNI-Q80H, R-GDVF-3ZR6, R-GF3B-HRHV
