...
Provides simple logging to stdout/stderr following systemd conventions. No configuration, no file output, no dependencies beyond standard library.
...
- Thread-safe not required (Phase 1 is single-threaded per connection)
