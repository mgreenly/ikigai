...
`project/plan/` directory it heads own the **build order** of the dropbox landing
...
task. The composition root (`cmd/dropbox/main.go`) is the one shared file
...
`bin/check-migrations dropbox` all succeed with zero failures. "Covered" means
