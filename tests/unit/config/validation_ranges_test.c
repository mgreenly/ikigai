...
END_TEST START_TEST(test_config_port_valid_range)
{
    ...
    fprintf(f1,
            "{\"openai_api_key\": \"test\", \"openai_model\": \"gpt-4-turbo\", \"openai_temperature\": 0.7, \"openai_max_completion_tokens\": 4096, \"openai_system_message\": null, \"listen_address\": \"127.0.0.1\", \"listen_port\": 1024}");
    fclose(f1);
    ...
    fprintf(f2,
            "{\"openai_api_key\": \"test\", \"openai_model\": \"gpt-4-turbo\", \"openai_temperature\": 0.7, \"openai_max_completion_tokens\": 4096, \"openai_system_message\": null, \"listen_address\": \"127.0.0.1\", \"listen_port\": 65535}");
    fclose(f2);
...
END_TEST START_TEST(test_config_valid_openai_system_message)
{
    ...
    ck_assert_ptr_nonnull(f);
    fprintf(f,
            "{\"openai_api_key\": \"test\", \"openai_model\": \"gpt-5-mini\", \"openai_temperature\": 0.7, \"openai_max_completion_tokens\": 4096, \"openai_system_message\": \"You are a helpful assistant\", \"listen_address\": \"127.0.0.1\", \"listen_port\": 1984}");
    fclose(f);
