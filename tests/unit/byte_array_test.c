...
static Suite *byte_array_suite(void)
{
    Suite *s;
    TCase *tc_core;

    s = suite_create("ByteArray");
    ...
    tcase_add_test_raise_signal(tc_core, test_byte_array_size_null_asserts, SIGABRT);
    tcase_add_test_raise_signal(tc_core, test_byte_array_capacity_null_asserts, SIGABRT);
    tcase_add_test_raise_signal(tc_core, test_byte_array_get_out_of_bounds_asserts, SIGABRT);
    tcase_add_test_raise_signal(tc_core, test_byte_array_delete_out_of_bounds_asserts, SIGABRT);
    tcase_add_test_raise_signal(tc_core, test_byte_array_set_out_of_bounds_asserts, SIGABRT);
    tcase_add_test_raise_signal(tc_core, test_byte_array_insert_out_of_bounds_asserts, SIGABRT);
#endif
