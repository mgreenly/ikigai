...
START_TEST(test_cmd_get_all) {
    ...
    ck_assert_uint_eq(count, 23);     // clear, mark, rewind, fork, kill, send, wait, reap, agents, help, model, system, tool, refresh, pin, unpin, toolset, summary, load, unload, skills, skillset, exit
