/**
 * @file cmd_filter_mail_test.c
 * @brief Unit tests for /filter-mail command
 */
...
START_TEST(test_filter_mail_by_sender) {
    ...
    sender1->uuid = talloc_strdup(sender1, "sender-uuid-abc");
    sender1->name = NULL;
    ...
    sender2->uuid = talloc_strdup(sender2, "sender-uuid-xyz");
    sender2->name = NULL;
...
START_TEST(test_filter_mail_partial_uuid) {
    ...
    sender->uuid = talloc_strdup(sender, "sender-uuid-abc123");
    sender->name = NULL;
...
static Suite *filter_mail_suite(void)
{
    ...
    tcase_add_test(tc, test_filter_mail_by_sender);
    tcase_add_test(tc, test_filter_mail_partial_uuid);
    tcase_add_test(tc, test_filter_mail_shows_header);
    tcase_add_test(tc, test_filter_mail_no_matches);
...
int main(void)
{
    ...
    srunner_set_xml(sr, "reports/check/unit/apps/ikigai/commands/cmd_filter_mail_test.xml");
