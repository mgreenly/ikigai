/**
 * @file cmd_read_mail_coverage_test.c
 * @brief Coverage tests for /read-mail command error paths
 */
...
static Suite *read_mail_coverage_suite(void)
{
    Suite *s = suite_create("Read Mail Command Coverage");
    TCase *tc = tcase_create("Core");
    tcase_set_timeout(tc, IK_TEST_TIMEOUT);

    tcase_add_checked_fixture(tc, setup, teardown);

    tcase_add_test(tc, test_read_mail_missing_args);
    tcase_add_test(tc, test_read_mail_empty_args);
    tcase_add_test(tc, test_read_mail_invalid_id_format);
    tcase_add_test(tc, test_read_mail_invalid_id_zero);
    tcase_add_test(tc, test_read_mail_invalid_id_negative);
...
int main(void)
{
    ...
    Suite *s = read_mail_coverage_suite();
    SRunner *sr = srunner_create(s);
    srunner_set_xml(sr, "reports/check/unit/apps/ikigai/commands/cmd_read_mail_coverage_test.xml");
