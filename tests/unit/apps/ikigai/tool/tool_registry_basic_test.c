...
static Suite *tool_registry_basic_suite(void)
{
    Suite *s = suite_create("ToolRegistryBasic");
...
{
    int number_failed;
    Suite *s = tool_registry_basic_suite();
    SRunner *sr = srunner_create(s);
    srunner_set_xml(sr, "reports/check/unit/apps/ikigai/tool/tool_registry_basic_test.xml");
