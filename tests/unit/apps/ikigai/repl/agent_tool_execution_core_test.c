...
/**
 * @file agent_tool_execution_core_test.c
 * @brief Unit tests for agent-based tool execution - core agent context
 *
 ...
 * Test suite
 */
static Suite *agent_tool_execution_core_suite(void)
{
    Suite *s = suite_create("agent_tool_execution_core");
...
int main(void)
{
    Suite *s = agent_tool_execution_core_suite();
    SRunner *sr = srunner_create(s);
    srunner_set_xml(sr, "reports/check/unit/apps/ikigai/repl/agent_tool_execution_core_test.xml");
