...
/**
 * @file repl_tool_completion_handle_test.c
 * @brief Unit tests for ik_repl_handle_agent_tool_completion
 *
 * Tests the tool completion handler that transitions agent state
 * and triggers render/continuation as needed.
 */
 ...
 * Test suite
 */
static Suite *repl_tool_completion_handle_suite(void)
{
    Suite *s = suite_create("repl_tool_completion_handle");
...
int main(void)
{
    Suite *s = repl_tool_completion_handle_suite();
    SRunner *sr = srunner_create(s);
    srunner_set_xml(sr, "reports/check/unit/apps/ikigai/repl/repl_tool_completion_handle_test.xml");
