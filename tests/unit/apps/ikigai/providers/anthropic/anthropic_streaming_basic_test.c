...
/**
 * @file anthropic_streaming_basic_test.c
 * @brief Unit tests for Anthropic basic streaming and content accumulation
 *
 * Tests basic streaming events, content deltas, and text accumulation
...
static Suite *anthropic_streaming_basic_suite(void)
{
...
int main(void)
{
    Suite *s = anthropic_streaming_basic_suite();
    SRunner *sr = srunner_create(s);
    srunner_set_xml(sr, "reports/check/unit/apps/ikigai/providers/anthropic/anthropic_streaming_basic_test.xml");
