...
// Coverage tests for Google request helpers (part 2)
...
static Suite *request_helpers_coverage2_suite(void)
{
    Suite *s = suite_create("Google Request Helpers Coverage 2");

    TCase *tc_error = tcase_create("Error Paths 2");
...
int32_t main(void)
{
    Suite *s = request_helpers_coverage2_suite();
    SRunner *sr = srunner_create(s);
    srunner_set_xml(sr, "reports/check/unit/apps/ikigai/providers/google/request_helpers_coverage2_test.xml");
