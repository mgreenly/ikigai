 ...
 * @brief Unit tests for workspace cursor down cursor movement operations
 */
...
static Suite *workspace_cursor_down_suite(void)
{
    Suite *s = suite_create("Workspace Cursor Down");
...
{
    int number_failed;
    Suite *s = workspace_cursor_down_suite();
