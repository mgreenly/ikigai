 ...
 * @brief Unit tests for workspace kill_to_line_end operation (Ctrl+K)
 */
...
static Suite *workspace_kill_to_line_end_suite(void)
{
    Suite *s = suite_create("Workspace Kill To Line End");
...
{
    int number_failed;
    Suite *s = workspace_kill_to_line_end_suite();
