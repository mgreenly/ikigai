/**
 * @file cursor_movement_test.c
 * @brief Unit tests for workspace cursor movement operations
 */
...
static Suite *workspace_cursor_movement_suite(void)
{
    Suite *s = suite_create("Workspace Cursor Movement");
...
{
    int number_failed;
    Suite *s = workspace_cursor_movement_suite();
