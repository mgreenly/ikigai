...
START_TEST(test_help_lists_help)
{
    ...
    // Line 7 should be /help (shifted due to /fork at line 4, /kill at line 5, /send at line 6)
    const char *line = NULL;
    size_t length = 0;
...
START_TEST(test_help_lists_model)
{
    ...
    // Line 8 should be /model (shifted due to /fork at line 4, /kill at line 5, /send at line 6)
    const char *line = NULL;
    size_t length = 0;
...
START_TEST(test_help_lists_system)
{
    ...
    // Line 9 should be /system (shifted due to /fork at line 4, /kill at line 5, /send at line 6)
    const char *line = NULL;
    size_t length = 0;
