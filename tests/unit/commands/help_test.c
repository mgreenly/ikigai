...
START_TEST(test_help_lists_help)
{
    ...
    // Line 5 should be /help (shifted due to /fork at line 4)
    const char *line = NULL;
    size_t length = 0;
...
START_TEST(test_help_lists_model)
{
    ...
    // Line 6 should be /model (shifted due to /fork at line 4)
    const char *line = NULL;
    size_t length = 0;
...
START_TEST(test_help_lists_system)
{
    ...
    // Line 7 should be /system (shifted due to /fork at line 4)
    const char *line = NULL;
    size_t length = 0;
