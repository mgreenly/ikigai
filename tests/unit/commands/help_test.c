...
START_TEST(test_help_lists_help)
{
    ...
    // Line 9 should be /help (shifted due to /fork, /kill, /send, /check-mail, /read-mail)
    const char *line = NULL;
    size_t length = 0;
...
START_TEST(test_help_lists_model)
{
    ...
    // Line 10 should be /model (shifted due to /fork, /kill, /send, /check-mail, /read-mail)
    const char *line = NULL;
    size_t length = 0;
...
START_TEST(test_help_lists_system)
{
    ...
    // Line 11 should be /system (shifted due to /fork, /kill, /send, /check-mail, /read-mail)
    const char *line = NULL;
    size_t length = 0;
