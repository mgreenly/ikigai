...
START_TEST(test_help_lists_help)
{
    ...
    // Line 8 should be /help (shifted due to /fork at line 4, /kill at line 5, /send at line 6, /check-mail at line 7)
    const char *line = NULL;
    size_t length = 0;
...
START_TEST(test_help_lists_model)
{
    ...
    // Line 9 should be /model (shifted due to /fork at line 4, /kill at line 5, /send at line 6, /check-mail at line 7)
    const char *line = NULL;
    size_t length = 0;
...
START_TEST(test_help_lists_system)
{
    ...
    // Line 10 should be /system (shifted due to /fork at line 4, /kill at line 5, /send at line 6, /check-mail at line 7)
    const char *line = NULL;
    size_t length = 0;
