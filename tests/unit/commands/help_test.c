...
START_TEST(test_help_lists_help)
{
    ...
    // Line 10 should be /help (shifted due to /fork, /kill, /send, /check-mail, /read-mail, /delete-mail)
    const char *line = NULL;
    size_t length = 0;
...
START_TEST(test_help_lists_model)
{
    ...
    // Line 11 should be /model (shifted due to /fork, /kill, /send, /check-mail, /read-mail, /delete-mail)
    const char *line = NULL;
    size_t length = 0;
...
START_TEST(test_help_lists_system)
{
    ...
    // Line 12 should be /system (shifted due to /fork, /kill, /send, /check-mail, /read-mail, /delete-mail)
    const char *line = NULL;
    size_t length = 0;
