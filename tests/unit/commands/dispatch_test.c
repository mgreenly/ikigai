...
START_TEST(test_cmd_get_all) {
    ...
    ck_assert_uint_eq(count, 13);     // clear, mark, rewind, fork, kill, send, check-mail, read-mail, delete-mail, help, model, system, debug
    ...
    ck_assert_str_eq(cmds[12].name, "debug");
