...
START_TEST(test_http_write_callback_user_callback_error) {
    ...
    res_t add_res = ik_openai_multi_add_request(multi, cfg, conv, error_stream_callback, ctx);
    ck_assert(!add_res.is_err);
...
START_TEST(test_http_write_callback_user_callback_success)
{
    ...
    res_t add_res = ik_openai_multi_add_request(multi, cfg, conv, success_stream_callback, NULL);
    ck_assert(!add_res.is_err);
