...
START_TEST(test_serialize_tool_call_complex)
{
...
START_TEST(test_serialize_tool_call_null_parent)
{
    ik_openai_msg_t *msg = ik_openai_msg_create_tool_call(
...
START_TEST(test_serialize_tool_result_complex)
{
...
START_TEST(test_serialize_tool_result_null_parent)
{
