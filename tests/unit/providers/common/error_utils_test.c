...
START_TEST(test_user_message_auth_anthropic) {
    ...
    ck_assert_str_eq(msg, "Authentication failed for anthropic. Check your API key in ANTHROPIC_API_KEY or ~/.config/ikigai/credentials.json");
...
START_TEST(test_user_message_auth_openai) {
    ...
    ck_assert_ptr_nonnull(msg);
    ck_assert_str_eq(msg, "Authentication failed for openai. Check your API key in OPENAI_API_KEY or ~/.config/ikigai/credentials.json");
}
END_TEST
...
START_TEST(test_user_message_auth_google) {
    ...
    ck_assert_ptr_nonnull(msg);
    ck_assert_str_eq(msg, "Authentication failed for google. Check your API key in GOOGLE_API_KEY or ~/.config/ikigai/credentials.json");
}
END_TEST
