...
END_TEST START_TEST(test_thinking_budget_2_5_pro_low)
{
...
END_TEST START_TEST(test_thinking_budget_2_5_pro_med)
{
...
END_TEST START_TEST(test_thinking_budget_gemini_3_pro)
{
...
END_TEST START_TEST(test_supports_thinking_3_pro)
{
    bool supports = ik_google_supports_thinking("gemini-3-pro");
    ck_assert(supports);
}

END_TEST START_TEST(test_supports_thinking_1_5_pro)
{
...
END_TEST START_TEST(test_validate_thinking_1_5_pro_low)
{
...
END_TEST START_TEST(test_validate_thinking_null_model)
{
