/**
 * @file anthropic_response_helpers_test.c
 * @brief Unit tests for Anthropic response parsing helper functions
 */
...
static Suite *anthropic_response_helpers_suite(void)
{
    Suite *s = suite_create("Anthropic Response Helpers");
...
int main(void)
{
    Suite *s = anthropic_response_helpers_suite();
