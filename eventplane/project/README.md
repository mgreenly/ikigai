# eventplane/project — workspace layout

Everything the eventplane service needs to be **designed, planned, and built**
...
root** (`eventplane/`), which is also the directory the `ralph` build loop runs
from.
