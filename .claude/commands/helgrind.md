...
**Action:** Executes `make check-helgrind` and uses sub-agents with the coverage skillset to fix any thread errors (races, lock issues) found. Sub-agents run sequentially (one per file) and continue until all issues are resolved.
